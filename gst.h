...
// Tue Jun  2 15:01:14 2026 by ROOT version 6.40.00
// from TTree gst/GENIE Summary Event Tree
// found on file: 1000060120 961MeV G18 Data.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("1000060120 961MeV G18 Data.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("1000060120 961MeV G18 Data.root");
      }
...
void gst::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("hnl", &hnl, &b_hnl);
