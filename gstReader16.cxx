...
void gstReader16()
{
  ...
  {"1p0n1k0",                           "1p 0#pi 1K^{0}",                            1,  0,   0,   0,   0,  0,  0,  1,  0,  1},
  {"1p1n1k0",                           "1p 1#pi 1K^{0}",                            1,  1,   0,   0,   0,  0,  0,  1,  0,  1},
  {"1p0n0pip1pim1kp1km",                "1p 0#pi 1#pi^{-} 1K^{+} 1K^{-}",            1,  0,   0,   1,   0,  1,  1,  0,  1,  2},
  {"1p0n1pip1pim1kp1km",                "1p 0#pi 1#pi^{+} 1#pi^{-} 1K^{+} 1K^{-}",   1,  0,   1,   1,   0,  1,  1,  0,  2,  2},
  {"1p2n1kp1km",                        "1p 2#pi 1K^{+} 1K^{-}",                     1,  2,   0,   0,   0,  1,  1,  0,  0,  2},
  {"1p1n1pip1kp1km",                    "1p 1#pi 1#pi^{+} 1K^{+} 1K^{-}",            1,  1,   1,   0,   0,  1,  1,  0,  1,  2},
  {"1p1n1pip1pim1kp1km",                "1p 1#pi 1#pi^{+} 1#pi^{-} 1K^{+} 1K^{-}",   1,  1,   1,   1,   0,  1,  1,  0,  2,  2},
  {"1p2n1pip1kp1km",                    "1p 2#pi 1#pi^{+} 1K^{+} 1K^{-}",            1,  2,   1,   0,   0,  1,  1,  0,  1,  2},
  {"1p1n0pip1pim1kp1km",                "1p 1#pi 1#pi^{-} 1K^{+} 1K^{-}",            1,  1,   0,   1,   0,  1,  1,  0,  1,  2},
  {"1p0n1pip1km1k0",                    "1p 0#pi 1#pi^{+} 1K^{-} 1K^{0}",            1,  0,   1,   0,   0,  0,  1,  1,  1,  2},
  {"0p0n3pi0k",                         "0p 0#pi 3#pi 0K",                           0,  0,   1,   1,   1,  0,  0,  0,  3,  0},
  {"0p0n2pi0k",                         "0p 0#pi 2#pi 0K",                           0,  0,   1,   1,   0,  0,  0,  0,  2,  0},
...
//        DrawTopo(histos[t], topos[t].name);
    ...
    TCanvas* cALL = new TCanvas("cALL", "1np2nk Topologies", 1600, 1200);
    cALL->Divide(2, 2);
	...
	gStyle->SetOptStat(0);
        ...
        for (int t = 0; t < (int)topos.size(); t++)
        {
            ...
            hc->SetTitle("1 np 2 nk Topologies");
    ...
    cALL->SaveAs("1np2nk_topologies.png");

    TCanvas* cLOG = new TCanvas("cLOG", "Log 1np2nk Topologies", 1600, 1200);
    cLOG->Divide(2, 2);
    ...
    for (int var = 0; var < 4; var++)
    {
	    ...
	    cLOG->SaveAs("1np2nk_topologies->log.png");
    // 2D 
