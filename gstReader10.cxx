...
//        DrawTopo(histos[t], topos[t].name);
    ...
    TCanvas* cALL = new TCanvas("cALL", "1nKp0nKm Topologies", 1600, 1200);
    cALL->Divide(2, 2);
	...
	gStyle->SetOptStat(0);
        ...
        for (int t = 0; t < (int)topos.size(); t++)
        {
            ...
            hc->SetTitle("1nKp 0nKm Topologies");
    ...
    cALL->SaveAs("1nkp0nkm_topologies.png");

    TCanvas* cLOG = new TCanvas("cLOG", "Log 1nKp0nKm Topologies", 1600, 1200);
    cLOG->Divide(2, 2);
	...
	gPad->SetLogy(1);
	    ...
	    cLOG->SaveAs("1nkp0nkm_topologies->log.png");
    // 2D 
