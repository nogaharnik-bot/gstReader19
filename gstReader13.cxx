...
//        DrawTopo(histos[t], topos[t].name);
    ...
    TCanvas* cALL = new TCanvas("cALL", "1nP1nKp1nKm Topologies", 1600, 1200);
    cALL->Divide(2, 2);
	...
	gStyle->SetOptStat(0);
        ...
        for (int t = 0; t < (int)topos.size(); t++)
        {
            ...
            hc->SetTitle("1nP 1nKp 1nKm Topologies");
    ...
    cALL->SaveAs("1nP1nkp1nkm_topologies.png");

    TCanvas* cLOG = new TCanvas("cLOG", "Log 1nP1nKp1nKm Topologies", 1600, 1200);
    cLOG->Divide(2, 2);
	...
	gPad->SetLogy(1);
	    ...
	    cLOG->SaveAs("1nP1nkp1nkm_topologies->log.png");
    // 2D 
