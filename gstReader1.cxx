...
void gstReader1()
{
    ...
    {
        return {
            new TH1D("et_"+name,    title+";Energy Transfer (GeV);Events", 100, 0,   1),
            new TH1D("theta_"+name, title+";#theta_{e} (rad);Events",      100, 0,   .4),
            new TH1D("Q2_"+name,    title+";Q^{2} (GeV^{2});Events",       100, 0,   1),
            new TH1D("W_"+name,     title+";W (GeV);Events",               100, 0.8, 1.3)
        };
    };
    ...
    {"1p0pi_4n",        "1p 4n 0#pi",                 1,  4,   0,   0,   0,  0,  0,  0,  0,  0},
};    
...
//        DrawTopo(histos[t], topos[t].name);
    ...
    cAll->SaveAs("qel_topologies.png");
